...
{
	update_universal_citekeydisplay();
}

function update_universal_citekeydisplay(argument)
{
	// input
	var author_input = document.getElementById('author-input');
	var year_input   = document.getElementById('year-input');
	var doi_input    = document.getElementById('doi-input');
...
// from http://stackoverflow.com/questions/1240408
